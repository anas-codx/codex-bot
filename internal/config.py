...
class Config:
    def __init__(self):
        ...
        self.botApi = os.getenv("botApi", "") # botApi: get this from #BotFather on telegram
        self.baseUrl = os.getenv("baseUrl", "https://erp.saitm.ac.in") # base url of college erp site (you can visit https://erp.saitm.ac.in)
        self.authorId = list(map(int, os.getenv("authorId", "8132481394").split())) # telegram user_id of all the admins of the bot
        self.emailId = os.getenv("emailId", "codexsaitm@gmail.com") # official notify mail of saitm codex club
        self.emailPass = os.getenv("emailPass", "") # emails pass for sending emails to students using smtp server
